...
def calc_avg_power(directory: str) -> tuple[float, float, float, float, float]:
...
for current in current_vals:
    ...
    df_dict["shelly_current"].append(calc_values[0])
    df_dict["shelly_voltage"].append(calc_values[1])
    df_dict["shelly_power"].append(calc_values[2])
    df_dict["pico_current"].append(calc_values[3])
    df_dict["pico_voltage"].append(calc_values[4])
